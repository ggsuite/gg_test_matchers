...
void main() {
  group('gg_test_matchers_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_test_matchers_version.dart');
